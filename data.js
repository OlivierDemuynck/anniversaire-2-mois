...
window.SITE_DATA = {
  ...
  months: [
    ...
    {
      number: 3,
      dateRange: "13 août → 13 septembre 2026",
      subtitle: "90 jours déjà, à tes côtés",
      counterSub: "Encore loin d'être les derniers",
      theme: {
        c1: "235,175,40",
        c2: "200,100,35",
        glow: "150,100,15",
...
window.TIMELINE_DATA = [
  { date: "6 octobre 2023", icon: "📖", title: "Le début d'une histoire", description: "Le soir où on s'est rencontré" },
  { date: "6 octobre 2023", icon: "🎮", title: "Premières parties ensemble", description: "On a commencé à traîner sur les jeux ensemble." },
  { date: "6 octobre 2023", icon: "🤗", title: "Premier compliment", description: "Le premier compliment que tu m'a fait c'était pour mon dessin de monsieur jack" },
  { date: "14 novembre 2023", icon: "👽", title: "Mon clone ?", description: "Le premier surnom qu'on s'est donné." },
  { date: "Janvier 2024", icon: "🤝", title: "Devenus amis", description: "Je pense que à ce moment là on était ami, on se l'est pas dit clairement mais j'avais ce ressenti en lisant les messages" },
  { date: "27 janvier 2024", icon: "🥲", title: "Premier moment émotion", description: "Ce soir là, on c'était pas parlé pendant 3j et on voulait pas se quitter tellement on c'était manqué." },
  { date: "28 janvier 2024", icon: "🥺", title: "Premier vrai surnom", description: "Mon chacal préféré fut le premier des nombreux surnoms que tu m'a donné et toi c'était bebou" },
  { date: "6 juillet 2024", icon: "💥", title: "Première dispute", description: "Je t'avais fait attendre et j'était en auto farm sur fishing simulator.." },
  { date: "7 juillet 2024", icon: "🫶", title: "Première réconciliation", description: "On s'est excusé tout les deux puis on a joué à deux" },
  { date: "24 juillet 2024", icon: "📞", title: "Premier appel", description: "Première fois que j'entendais ta douce voix" },
